...
public class WaypointEditor 
{
    ...
    public static void OnDrawSceneGizmo(Waypoint waypoint, GizmoType gizmotype)
    {
        ...
        if(waypoint.Stop !=null)
        {
            Gizmos.color = Color.black;
            Gizmos.DrawLine(waypoint.transform.position,waypoint.Stop.transform.position);
        }

        if(waypoint.Reverse != null)
        {
            Gizmos.color = Color.white;
            Gizmos.DrawLine(waypoint.transform.position,waypoint.Reverse.transform.position);
        }
    }
}
